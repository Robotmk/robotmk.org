---
draft: false
title: "RCC im CMK Root-Agent - die Details"
# --- Italic subheading
...
*(Werk [#20190](https://checkmk.com/werk/20190), 2. September 2026, derzeit 3.0.0b1, 2.5 und 2.4 folgen)*
...
- **2.4.0p33 / 2.5.0p6 bis p11:** Das Backen bricht bei Root + RCC ab. Hier hilft entweder das Update auf mindestens p12 oder einer der beiden im Werk genannten Wege (Non-Root bzw. Conda).
...
- **Ab 2.4.0p37 / 2.5.0p13/3.0:** Du triffst die Entscheidung, die Inline-Hilfe liefert den Kontext dazu.
