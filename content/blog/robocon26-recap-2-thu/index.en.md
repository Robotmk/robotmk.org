...
**Fabian Streitel** has been advising his clients on test automation for over ten years. He presented a fascinating approach to a problem that many teams with large test suites are familiar with: How can you provide **feedback as quickly as possible** when the complete **test execution takes hours or even days**?
